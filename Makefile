...
datasets:
	source venv/bin/activate && convert bundle/analyze/datasets/snowflake-monitoring/ rawdata/ bundle/analyze/datasets/snowflake-monitoring/output || convert bundle/analyze/datasets/snowflake-monitoring/ rawdata/ bundle/analyze/datasets/snowflake-monitoring/output
